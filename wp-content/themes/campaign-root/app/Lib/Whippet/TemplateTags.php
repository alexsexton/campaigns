...
namespace Dxw\GdsCampaignRoot\Lib\Whippet;
...
class TemplateTags
{
    ...
    {
        ?>
        <div class="whippet alert template-warning" style="background: rgb(255,100,100); width: 100%; padding: 10px;"><h1>You're using a fallback template: <?php echo basename(\Dxw\GdsCampaignRoot\Lib\Whippet\Layout::$wordpress_template);
