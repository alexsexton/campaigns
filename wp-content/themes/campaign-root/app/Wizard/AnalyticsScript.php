...
class AnalyticsScript implements \Dxw\Iguana\Registerable
{
    ...
    {
        add_action('campaigns_before_body_gds_analytics', [$this, 'campaignsBeforeBodyGDSAnalytics']);
        add_action('campaigns_before_body', [$this, 'campaignsBeforeBody']);
        add_action('campaigns_after_body', [$this, 'campaignsAfterBody']);
    }

    public function campaignsBeforeBodyGDSAnalytics()
    {
        ?>
        <script>
    ...
    public function campaignsBeforeBody()
    {
