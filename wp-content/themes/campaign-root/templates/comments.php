...
<?php if (have_comments()) : ?>
    ...
    <section id="comments" class="comments">
        ...
        <ol class="media-list">
            <?php wp_list_comments(array('walker' => new \Dxw\GdsCampaignRoot\Lib\RootsWalkerComment())); // TODO: What does this walker do, do we need it? How do we make sure this pulls through the comment partial? ?>
        </ol>
