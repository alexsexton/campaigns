...
<div class="follow-us">
        <ul>
            ...
            <li><a href="//www.facebook.com/<?php the_field('facebook_id', 'option'); ?>" target="_blank">
            ...
            <li><a href="//twitter.com/<?php the_field('twitter_id', 'option'); ?>" target="_blank">
            ...
            <li><a href="//youtube.com/<?php the_field('youtube_id', 'option'); ?>" target="_blank">
            ...
            <li><a href="//www.linkedin.com/company/<?php the_field('linkedin_id', 'option'); ?>" target="_blank">
