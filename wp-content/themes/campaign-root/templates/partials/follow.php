<?php if(get_field('facebook_id', 'option') || get_field('youtube_id', 'option') || get_field('twitter_id', 'option') || get_field('linkedin_id', 'option') || get_field('instagram_id', 'option') ) : ?>
<div class="follow-us">
        <ul>
