...
<section class="share-this">
    ...
    <ul>
        <li><a href="//www.facebook.com/sharer.php?href=<?php echo $post_url; ?>" target="_blank" class="share-this--facebook">
        ...
        <li><a href="//twitter.com/share?text=&text;url=<?php echo $post_title; ?>&amp;url=<?php echo $post_url; ?>" target="_blank" class="share-this--twitter">
        ...
        <li><a href="//www.linkedin.com/shareArticle?mini=true&amp;ampurl=<?php echo $post_url; ?>&amp;title=<?php echo $post_title; ?>&amp;summary=<?php echo $post_excerpt; ?>&amp;source=<?php echo $source; ?>" target="_blank" class="share-this--linkedin">
